...
const HeroWithProduct = () => {
  ...
  return (
    <>
      <div className="pt-24 px-4 [ lg:px-0 ] relative bg-primary overflow-hidden">
      ...
      {/* <div className="-mt-12 px-4 [ lg:px-0 ] relative text-gray-700 overflow-hidden">
        <div className="container max-w-screen-lg mx-auto flex flex-col [ md:flex-row md:items-center md:justify-end ]">
          <div className="flex flex-col w-full [ md:w-1/2 ] align-bottom transform rotate-12 translate-y-6">
            <Image src={marcOne} alt="Marc One" />
          </div>
        </div>
